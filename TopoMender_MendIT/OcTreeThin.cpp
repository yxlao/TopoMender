        ...
        for (int i = 0; i < 2; i++)
            for (int j = 0; j < 2; j++)
                for (int k = 0; k < 2; k++) {
                    ...
                    nCell = nPoint[i][j][k];
                    if (RecThinCell(pNodeCell, nCell)) bRtn = true;
                }
        for (int i = 0; i < 2; i++)
            for (int j = 0; j < 2; j++) {
                for (int k = 0; k < 2; k++) {
                ...
                if (RecThinFace(pNodeFace, nFace, 0)) bRtn = true;
                for (int k = 0; k < 2; k++) {
                    pNodeFace[k] = pNodePoint[j][k][i];
                    nFace[k] = nPoint[j][k][i];
                }
                if (RecThinFace(pNodeFace, nFace, 1)) bRtn = true;
                for (int k = 0; k < 2; k++) {
                    pNodeFace[k] = pNodePoint[i][j][k];
                    nFace[k] = nPoint[i][j][k];
                }
                if (RecThinFace(pNodeFace, nFace, 2)) bRtn = true;
            }
        for (int i = 0; i < 2; i++) {
            for (int j = 0; j < 2; j++)
                for (int k = 0; k < 2; k++) {
            ...
            if (RecThinEdge(pNodeEdge, nEdge, 0)) bRtn = true;
            for (int j = 0; j < 2; j++)
                for (int k = 0; k < 2; k++) {
                    pNodeEdge[j][k] = pNodePoint[k][i][j];
                    nEdge[j][k] = nPoint[k][i][j];
                }
            if (RecThinEdge(pNodeEdge, nEdge, 1)) bRtn = true;
            for (int j = 0; j < 2; j++)
                for (int k = 0; k < 2; k++) {
                    pNodeEdge[j][k] = pNodePoint[j][k][i];
                    nEdge[j][k] = nPoint[j][k][i];
                }
            if (RecThinEdge(pNodeEdge, nEdge, 2)) bRtn = true;
        }
        if (RecThinPoint(pNodePoint, nPoint)) bRtn = true;
    } else {
