...
void OcTree::RecCheckPointCell(UCHAR* pNode,
                               UINT64 n64Position,
                               int nLevel,
                               UINT64 n64CheckPoint) {
    if (!CheckPointForCell(n64Position, nLevel, n64CheckPoint)) return;
...
void OcTree::RecCheckPointFace(UCHAR* pNode[2],
            ...
            case 0:
                ...
                for (int i = 0; i < 2; i++)
                    for (int j = 0; j < 2; j++) {
                        ...
                        RecCheckPointFace(pNodeFace, n64Face, nFace, 0,
                                          n64CheckPoint);
                    }
                for (int i = 0; i < 2; i++) {
                    for (int j = 0; j < 2; j++)
                    ...
                    RecCheckPointEdge(pNodeEdge, n64Edge, nEdge, 1,
                                      n64CheckPoint);
                    for (int j = 0; j < 2; j++)
                        for (int k = 0; k < 2; k++) {
                            pNodeEdge[j][k] = pNodePoint[j][k][i];
                    ...
                    RecCheckPointEdge(pNodeEdge, n64Edge, nEdge, 2,
                                      n64CheckPoint);
                }
                RecCheckPointPoint(pNodePoint, n64Point, nPoint, n64CheckPoint);
                break;
            case 1:
                ...
                for (int i = 0; i < 2; i++)
                    for (int j = 0; j < 2; j++) {
                        ...
                        RecCheckPointFace(pNodeFace, n64Face, nFace, 1,
                                          n64CheckPoint);
                    }
                for (int i = 0; i < 2; i++) {
                    for (int j = 0; j < 2; j++)
                    ...
                    RecCheckPointEdge(pNodeEdge, n64Edge, nEdge, 0,
                                      n64CheckPoint);
                }
                RecCheckPointPoint(pNodePoint, n64Point, nPoint, n64CheckPoint);
                break;
            case 2:
                ...
                for (int i = 0; i < 2; i++)
                    for (int j = 0; j < 2; j++) {
                        ...
                        RecCheckPointFace(pNodeFace, n64Face, nFace, 2,
                                          n64CheckPoint);
                    }
                for (int i = 0; i < 2; i++) {
                    for (int j = 0; j < 2; j++)
...
void OcTree::RecCheckPointEdge(UCHAR* pNode[2][2],
...
void OcTree::RecCheckPointPoint(UCHAR* pNode[2][2][2],
                                UINT64 n64Position[2][2][2],
                                int nLevel[2][2][2],
                                UINT64 n64CheckPoint) {
    UINT64 n64ThisPoint;
    GetPointPosition(n64Position, nLevel, n64ThisPoint);
    if (!CheckPointForPoint(n64ThisPoint, n64CheckPoint)) return;
