...
public:
    ...
    hash_map<unsigned int, unsigned int>
            m_hashElementExtend;  // 0 -- only visited once;  1 -- circled
...
public:
    ...
    void RecDuplicateOcTree(UCHAR **ppNode,
                            UCHAR *pOcTreeNode,
                            OcTree *pOcTree);
    ...
    void RecContouringEdge(UCHAR *pCoNode,
    ...
    bool CheckEdgeForCell(UINT64 n64CoCell,
                          int nCoCell,
                          UINT64 n64Edge,
                          int nEdge,
                          int dirEdge);
    bool CheckFaceForCell(UINT64 n64CoCell,
                          int nCoCell,
                          UINT64 n64Face,
                          int nFace,
                          int dirFace);
    bool CheckCellForCell(UINT64 n64CoCell,
                          int nCoCell,
                          UINT64 n64Cell,
                          int nCell);
    bool CheckPointForFace(UINT64 n64CoFace,
                           int nCoFace,
                           int dirCoFace,
                           UINT64 n64Point);
    bool CheckEdgeForFace(UINT64 n64CoFace,
                          int nCoFace,
                          int dirCoFace,
                          UINT64 n64Edge,
                          int nEdge,
                          int dirEdge);
    bool CheckFaceForFace(UINT64 n64CoFace,
                          int nCoFace,
                          int dirCoFace,
                          UINT64 n64Face,
                          int nFace,
                          int dirFace);
    bool CheckCellForFace(UINT64 n64CoFace,
                          int nCoFace,
                          int dirCoFace,
                          UINT64 n64Cell,
                          int nCell);
    bool CheckPointForEdge(UINT64 n64CoEdge,
                           int nCoEdge,
                           int dirCoEdge,
                           UINT64 n64Point);
    bool CheckEdgeForEdge(UINT64 n64CoEdge,
                          int nCoEdge,
                          int dirCoEdge,
                          UINT64 n64Edge,
                          int nEdge,
                          int dirEdge);
    bool CheckFaceForEdge(UINT64 n64CoEdge,
                          int nCoEdge,
                          int dirCoEdge,
                          UINT64 n64Face,
                          int nFace,
                          int dirFace);
    bool CheckCellForEdge(UINT64 n64CoEdge,
                          int nCoEdge,
                          int dirCoEdge,
                          UINT64 n64Cell,
                          int nCell);
    bool CheckPointForPoint(UINT64 n64CoPoint, UINT64 n64Point);
    bool CheckEdgeForPoint(UINT64 n64CoPoint,
                           UINT64 n64Edge,
                           int nEdge,
                           int dirEdge);
    bool CheckFaceForPoint(UINT64 n64CoPoint,
                           UINT64 n64Face,
                           int nFace,
                           int dirFace);
    ...
    void RecCheckPointCell(UCHAR *pNode,
                           UINT64 n64Position,
                           int nLevel,
                           UINT64 n64CheckPoint);
    void RecCheckPointFace(UCHAR *pNode[2],
                           UINT64 n64Position[2],
                           int nLevel[2],
                           int dirFace,
                           UINT64 n64CheckPoint);
    void RecCheckPointEdge(UCHAR *pNode[2][2],
                           UINT64 n64Position[2][2],
                           int nLevel[2][2],
                           int dirEdge,
                           UINT64 n64CheckPoint);
    void RecCheckPointPoint(UCHAR *pNode[2][2][2],
                            UINT64 n64Position[2][2][2],
                            int nLevel[2][2][2],
                            UINT64 n64CheckPoint);
    void CheckEdge(UINT64 n64CheckEdge, int nCheckEdge, int dirCheckEdge);
    void RecCheckEdgeCell(UCHAR *pNode,
                          UINT64 n64Position,
                          int nLevel,
                          UINT64 n64CheckEdge,
                          int nCheckEdge,
                          int dirCheckEdge);
    void RecCheckEdgeFace(UCHAR *pNode[2],
                          UINT64 n64Position[2],
                          int nLevel[2],
                          int dirFace,
                          UINT64 n64CheckEdge,
                          int nCheckEdge,
                          int dirCheckEdge);
    void RecCheckEdgeEdge(UCHAR *pNode[2][2],
                          UINT64 n64Position[2][2],
                          int nLevel[2][2],
                          int dirEdge,
                          UINT64 n64CheckEdge,
                          int nCheckEdge,
                          int dirCheckEdge);
    void RecCheckEdgePoint(UCHAR *pNode[2][2][2],
                           UINT64 n64Position[2][2][2],
                           int nLevel[2][2][2],
                           UINT64 n64CheckEdge,
                           int nCheckEdge,
    ...
    void RecCheckFaceCell(UCHAR *pNode,
                          UINT64 n64Position,
                          int nLevel,
                          UINT64 n64CheckFace,
                          int nCheckFace,
                          int dirCheckFace);
    void RecCheckFaceFace(UCHAR *pNode[2],
                          UINT64 n64Position[2],
                          int nLevel[2],
                          int dirFace,
                          UINT64 n64CheckFace,
                          int nCheckFace,
                          int dirCheckFace);
    void RecCheckFaceEdge(UCHAR *pNode[2][2],
                          UINT64 n64Position[2][2],
                          int nLevel[2][2],
                          int dirEdge,
                          UINT64 n64CheckFace,
                          int nCheckFace,
                          int dirCheckFace);
    void RecCheckFacePoint(UCHAR *pNode[2][2][2],
                           UINT64 n64Position[2][2][2],
                           int nLevel[2][2][2],
                           UINT64 n64CheckFace,
                           int nCheckFace,
    ...
    void RecCheckCellCell(UCHAR *pNode,
                          UINT64 n64Position,
                          int nLevel,
                          UINT64 n64CheckCell,
                          int nCheckCell);
    void RecCheckCellFace(UCHAR *pNode[2],
                          UINT64 n64Position[2],
                          int nLevel[2],
                          int dirFace,
                          UINT64 n64CheckCell,
                          int nCheckCell);
    void RecCheckCellEdge(UCHAR *pNode[2][2],
                          UINT64 n64Position[2][2],
                          int nLevel[2][2],
                          int dirEdge,
                          UINT64 n64CheckCell,
                          int nCheckCell);
    void RecCheckCellPoint(UCHAR *pNode[2][2][2],
                           UINT64 n64Position[2][2][2],
                           int nLevel[2][2][2],
                           UINT64 n64CheckCell,
                           int nCheckCell);
    ...
    void CheckPoint2(UCHAR *pThisPoint[2][2][2],
                     UINT64 n64ThisPoint[2][2][2],
                     int nThisPoint[2][2][2],
                     Element *pTempPoint);
    void CheckEdge2(UCHAR *pThisEdge[2][2],
                    UINT64 n64ThisEdge[2][2],
                    int nThisEdge[2][2],
                    int dirCheckEdge,
                    Element *pTempEdge);
    void CheckFace2(UCHAR *pThisFace[2],
                    UINT64 n64ThisFace[2],
                    int nThisFace[2],
                    int dirCheckFace,
                    Element *pTempFace);
    void CheckCell2(UCHAR *pThisCell,
                    UINT64 n64ThisCell,
                    int nThisCell,
                    Element *pTempCell);
    void CheckPointDetail(UINT64 n64CheckPoint, Element *pCheckPoint);
    void CheckEdgeDetail(UINT64 n64CheckEdge,
                         int nCheckEdge,
                         int dirCheckEdge,
                         Element *pCheckEdge);
    void CheckFaceDetail(UINT64 n64CheckFace,
                         int nCheckFace,
                         int dirCheckFace,
                         Element *pCheckFace);
    void CheckCellDetail(UINT64 n64CheckCell,
                         int nCheckCell,
                         Element *pCheckCell);
    ...
    void RecSketchingSplit(UCHAR **ppNode,
                           UINT64 n64Position,
                           int nLevel,
                           int nLine);
    bool RecSketchingMerge(UCHAR *pNode, UINT64 n64Position, int nLevel);
    bool RecSketchingMergeCheckEdge(UCHAR *pNode[2][2],
                                    UINT64 n64Position[2][2],
                                    int nLevel[2][2],
                                    int dirEdge);
    bool RecSketchingMergeCheckFace(UCHAR *pNode[2],
                                    UINT64 n64Position[2],
                                    int nLevel[2],
                                    int dirFace);
    ...
    void PushWitnessEdge(UINT64 n64ThisEdge,
                         int nThisEdge,
                         int dirThisEdge,
                         UCHAR cPointer);
    void PushWitnessFace(UINT64 n64ThisFace,
                         int nThisFace,
                         int dirThisFace,
                         UCHAR cPointer);
    void PushWitnessCell(UINT64 n64ThisCell, int nThisCell, UCHAR cPointer);
    void RecPushWitnessFaceEdge(UCHAR *pNode[2][2],
                                UINT64 n64Position[2][2],
                                int nLevel[2][2],
                                int dirEdge,
                                UCHAR cCheck);
    void RecPushWitnessCellFace(UCHAR *pNode[2],
                                UINT64 n64Position[2],
                                int nLevel[2],
                                int dirFace,
                                UCHAR cCheck);
    void DualPushWitnessPoint(UCHAR *pNode[2][2][2],
                              UINT64 n64Position[2][2][2],
                              int nLevel[2][2][2],
                              UCHAR cPointer);
    void DualPushWitnessEdge(UCHAR *pNode[2][2],
                             UINT64 n64Position[2][2],
                             int nLevel[2][2],
                             int dirEdge,
                             UCHAR cPointer);
    void DualPushWitnessFace(UCHAR *pNode[2],
                             UINT64 n64Position[2],
                             int nLevel[2],
                             int dirFace,
                             UCHAR cPointer);
    ...
    Element *GetElementFace(
            UCHAR *pNode[2], int nLevel[2], int dirFace, int &nI, int &nIndex);
    Element *GetElementEdge(UCHAR *pNode[2][2],
                            int nLevel[2][2],
                            int dirEdge,
                            int &nI,
                            int &nJ,
                            int &nIndex);
    Element *GetElementPoint(UCHAR *pNode[2][2][2],
                             int nLevel[2][2][2],
                             int &nI,
                             int &nJ,
                             int &nK,
    ...
    void Search(UCHAR *pNode,
                ...
                int &nRtnLevel);
    void GetCellFromPosition(UINT64 n64Search,
                             int nSearch,
                             UCHAR *&pRtnNode,
                             UINT64 &n64RtnPosition,
                             int &nRtnLevel);
    void GetFaceFromPosition(UINT64 n64Search,
                             int nSearch,
                             int dirFace,
                             UCHAR *pRtnNode[2],
                             UINT64 n64RtnPosition[2],
                             int nRtnLevel[2]);
    void GetEdgeFromPosition(UINT64 n64Search,
                             int nSearch,
                             int dirEdge,
                             UCHAR *pRtnNode[2][2],
                             UINT64 n64RtnPosition[2][2],
                             int nRtnLevel[2][2]);
    void GetPointFromPosition(UINT64 n64Search,
                              int nSearch,
    ...
    void GetFacePosition(UINT64 n64Position[2],
                         int nLevel[2],
                         int dirFace,
                         int nI,
                         int iIndex,
                         UINT64 &n64RtnPosition);
    void GetEdgePosition(UINT64 n64Position[2][2],
                         int nLevel[2][2],
                         int dirEdge,
                         int nI,
                         int nJ,
                         int iIndex,
                         UINT64 &n64RtnPosition);
    void GetPointPosition(UINT64 n64Position[2][2][2],
                          int nLevel[2][2][2],
                          int nI,
                          int nJ,
                          int nK,
    ...
    UINT64 GetFaceCenterPosition(UINT64 n64Position[2],
                                 int nLevel[2],
                                 int dirFace);
    UINT64 GetEdgeCenterPosition(UINT64 n64Position[2][2],
                                 int nLevel[2][2],
                                 int dirEdge);
    UINT64 GetPointCenterPosition(UINT64 n64Position[2][2][2],
                                  int nLevel[2][2][2]);
