...
CFaceHeap::~CFaceHeap(void) { delete[] m_pElement; }
...
bool CFaceHeap::Push(UCHAR* pNode[2],
    ...
    m_pElement[iIndex] =
            CFaceHeapElement(pNode, n64Position, nLevel, dirFace, fValue);
...
bool CFaceHeap::Empty() { return (m_nNum == 0); }
